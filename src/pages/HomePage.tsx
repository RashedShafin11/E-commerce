...
const HomePage: React.FC = () => {
  return (
    <main className="container mx-auto px-4 py-4 md:py-8">
      ...
      {/* Promotional Banner */}
      <div className="mt-12 md:mt-20 bg-navy-900 rounded-2xl md:rounded-[3rem] overflow-hidden relative group">
        <div className="flex flex-col md:flex-row items-center">
          <div className="p-8 md:p-12 md:w-1/2 text-white">
            <span className="bg-orange-500 text-[10px] md:text-xs font-bold px-3 py-1 rounded-full mb-4 inline-block tracking-widest">NEW COLLECTION</span>
          ...
          <div className="w-full md:w-1/2 h-48 md:h-96 relative">
            <img 
